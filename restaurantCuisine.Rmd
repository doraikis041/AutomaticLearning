...
head(allRestaurant)
```
Analisis de datos faltantes y NAs
```{r Valores Faltantes}
...
pairs.panels(allRestaurant[,2:5], stars = TRUE)
```

```{r Gower}
# ### Modelos de clustering con datos categóricos
# ### opciones
# 
# # 1) Distancia de Gower
# # 2) Función kmodes (paquete KlaR)
# # 3) Paquete Kamila (muy nuevo)
# 
# ### Opción 1 distancia de gower
# library(cluster)
# # 1 construir matriz de disimilaridad
# setwd("C:/Users/usuario/Documents/ort")
# vinos <- read.csv2('winequality-red.csv')
# gower.dist <- daisy(vinos, metric = c("gower")) # otras opciones son euclidean, manhattan
# class(gower.dist)
# 
# # 2 modelar
# 
